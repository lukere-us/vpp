...
<html class="no-js" lang="">
    ...
    <body style="-moz-transform: scale(0.9, 0.9); -moz-transform-origin: 0 0; -webkit-transform:scale(0.9); -webkit-transform-origin: 0 0; -o-transform: scale(0.9); -o-transform-origin: 0 0;">
        <!--[if lte IE 9]>
        ...
        <div class="main-container">
            <div class="component-wrapper br" id="start-panel">
                <div class="component-container">
                    ...
                    <div class="button-secton">
                        <button id="B_001" class="deactivated button br"><span class="icon"><img src="img/start_icon.png" alt="start"></span> Start</button>
                        <button id="B_002" class="deactivated button br"><span class="icon"><img src="img/sut-d_icon.png" alt="Shutdown"></span> Shutdown</button>
                        <button id="B_003" class="deactivated button br"><span class="icon"><img src="img/pause_icon.png" alt="pause"></span> Pause</button>
            ...
            <div class="component-wrapper br" id="settings-panel">
                <div class="component-container">
                    <div class="button-section">
                        <button class="button br btn" data-fancybox data-src="#productionSetting" ><span class="icon"><img src="img/settings.png" alt="Settings"></span> Production Settings</button>
                        <!-- <button class="button br btn" data-fancybox data-src="#tankFarm" >Tank Farm</button> -->
                    </div>
                    <div id="time_display" class="time"></div>
                    <div class="alarms"><span> Alarms:</span> <span id="alarm_msg" class="alarm-set br"></span> </div>
                    ...
                    <div class="pop-up-window" id="productionSetting">
                        <div class="info-box">
                            ...
                            <ul>
                                <li><label>Phosphoric Acid Dosing(%)</label><input type="text" name="" id="TK201_DS"/></li>
            ...
            <div class="component-wrapper br" id="step-1">
                <div class="component-container">
                    ...
                    <img src="img/pips/feed-cooler.svg" alt="feed-cooler" class="svg pipe feed-cooler" id="feed-cooler">
                    ...
                    <img src="img/pips/feed-cooler.svg" alt="feed-heater" class="svg pipe feed-heater" id="feed-heater">
                    ...
                    <img src="img/pips/t-201-dashed-border.svg" alt="t-201-dashed" class="svg val t-201-dashed" id="t-201-dashed">
            ...
            <div class="component-wrapper br" id="step-2">
                <div class="component-container">
                    ...
                    <img src="img/pips/p-201-pump-bottom-pipe.svg" alt="p-201-pump-bottom-pipe" class="svg pipe p-201-pump-bottom-pipe" id="p-201-pump-bottom-pipe">
            ...
            <div class="component-wrapper br" id="step-3">
                <div class="component-container">
                    ...
                    <img src="img/pips/m-202-bot-pipe.svg" alt="m-202-bot-pipe" class="svg pipe m-202-bot-pipe" id="m-202-bot-pipe">
                    ...
                    <img src="img/pips/p-201-pump-bottom-pipe.svg" alt="p-201-pump-bottom-pipe" class="svg pipe p-201-pump-bottom-pipe" id="p-201-2-pump-bottom-pipe">
                    <img src="img/pips/p-203-stand.svg" alt="p-203-stand" class="svg pipe p-203-stand" id="p-203-stand">
                    <img src="img/elements/moter-horisontal-left.svg" alt="p-203" class="svg p-203" id="p-203">
                    <img src="img/pips/pi-connecter-tank-203.svg" alt="pi-connecter-tank-203" class="svg pipe pi-connecter-tank-203" id="pi-connecter-tank-203">
                    <img src="img/elements/inline-mixer.svg" alt="inline-mixer" class="svg inline-mixer" id="inline-mixer">
                    ...
                    <img src="img/pips/p-203-stand.svg" alt="p-204-stand" class="svg pipe p-204-stand fliph" id="p-204-stand">
                    <img src="img/elements/moter-horisontal-left.svg" alt="p-204" class="svg p-204 fliph" id="p-204">
                    <img src="img/pips/pi-o-09.svg" alt="pi-o-09" class="svg pipe pi-o-09" id="pi-o-09">
                    <img src="img/pips/feed-cooler.svg" alt="sep-heater" class="svg pipe sep-heater" id="sep-heater">
            ...
            <div class="component-wrapper br" id="step-4">
                <div class="component-container">
                    ...
                    <img src="img/pips/pi-connecter-tank-203.svg" alt="pi-s-05-2" class="svg pipe pi-s-05-2" id="pi-s-05-2">
                    <img src="img/pips/dashed-tip-1.svg" alt="dashed-tip-1" class="svg dashed-tip-1" id="dashed-tip-1">
                    ...
                    <img src="img/pips/p-203-stand.svg" alt="p-205-stand" class="svg pipe p-205-stand fliph" id="p-205-stand">
                    <img src="img/elements/moter-horisontal-left.svg" alt="p-205 " class="svg p-205 fliph" id="p-205">
            ...
            <div class="separator info-box">
                ...
                <div id="separator" class='info-box'>
                    <div class='field'><input type="checkbox" name="on" value="on" id='separator_status'><label for="on"> On</label><span id="sep_time"></span></div>
                    <div class='field'>
                        <input disabled checked type="radio" name="separator_opt" value="PR" id="product"><label for="product"> Product</label><br>
                        <input disabled type="radio" name="separator_opt" value="PE" id="partialej"><label for="partialej"> Partial Ej</label><br>
                        <input disabled type="radio" name="separator_opt" value="TE" id="totalej"><label for="totalej"> Total Ej</label><br>
                        <input disabled type="radio" name="separator_opt" value="CP" id='cip'><label for="cip"> CIP</label><br>
                        <input disabled type="radio" name="separator_opt" value="WR" id='water'><label for="water"> Water</label><br>
                    </div>
                </div>
            </div>
        </div>

    ...
    public function __construct() {
        ...
        if ($this->url_module) {
            ...
            if ($this->url_controller) {
                ...
                // check for controller: does such a controller exist ?$this->url_module . "/" . CONTROLLER_PATH . "/" . $this->url_controller . "/controller_" . $this->url_controller . '.class.php'
